...
fn test_categorical_market_automated_matcher() {
	...
	accounts[0].place_order(&mut runtime, U64(0), 0, U128(1000), 25, None, None).expect("order placement tx failed unexpectedly");
	accounts[0].place_order(&mut runtime, U64(0), 1, U128(900), 25, None, None).expect("order placement tx failed unexpectedly");
	accounts[0].place_order(&mut runtime, U64(0), 2, U128(1000), 25, None, None).expect("order placement tx failed unexpectedly");
	accounts[0].place_order(&mut runtime, U64(0), 3, U128(1000), 24, None, None).expect("order placement tx failed unexpectedly");
	accounts[0].place_order(&mut runtime, U64(0), 2, U128(1000), 50, None, None).expect("order placement tx failed unexpectedly");
