...
fn simplest_binary_order_matching_test() {
	...
	accounts[0].place_order(&mut runtime, U64(0), 0, U128(1000), 50, None, None).expect("order placement tx failed unexpectedly");
	accounts[0].place_order(&mut runtime, U64(0), 1, U128(1000), 50, None, None).expect("order placement tx failed unexpectedly");
...
fn partial_binary_order_matching_test() {
	...
	accounts[0].place_order(&mut runtime, U64(0), 1, U128(1000), 50, None, None).expect("order placement tx failed unexpectedly");
	accounts[0].place_order(&mut runtime, U64(0), 1, U128(1000), 50, None, None).expect("order placement tx failed unexpectedly");
	accounts[0].place_order(&mut runtime, U64(0), 1, U128(550), 50, None, None).expect("order placement tx failed unexpectedly");
	accounts[0].place_order(&mut runtime, U64(0), 1, U128(200), 50, None, None).expect("order placement tx failed unexpectedly");

	accounts[0].place_order(&mut runtime, U64(0), 0, U128(1000), 50, None, None).expect("order placement tx failed unexpectedly");
	accounts[0].place_order(&mut runtime, U64(0), 0, U128(1555), 50, None, None).expect("order placement tx failed unexpectedly");
