...
fn test_valid_binary_market_depth() {
	...
	accounts[0].place_order(&mut runtime, U64(0), U64(0), U128(60000), U128(60), None).expect("order placement tx failed unexpectedly");
	accounts[0].place_order(&mut runtime, U64(0), U64(1), U128(20000), U128(20), None).expect("order placement tx failed unexpectedly");
	accounts[0].place_order(&mut runtime, U64(0), U64(1), U128(30000), U128(30), None).expect("order placement tx failed unexpectedly");
